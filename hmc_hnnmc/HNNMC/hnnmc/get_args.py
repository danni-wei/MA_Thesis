...
def get_args():
    ...
    parser.add_argument('--dist_name', default='banana', type=str, help='name of the probability distribution function')
    ...
    parser.add_argument('--load_file_name', default='banana', type=str, help='if load training data, the file name (.pkl format)')
    parser.add_argument('--total_steps', default=5000, type=int, help='number of gradient steps')

    parser.add_argument('--hidden_dim', default=128, type=int, help='hidden dimension of mlp')
    ...
    parser.add_argument('--step_size', default=0.025, type=int, help='step size for time integration (leapfrog)')
    parser.add_argument('--print_every', default=200, type=int, help='number of gradient steps between prints')
    parser.add_argument('--verbose', dest='verbose', action='store_true', help='verbose?')
    parser.add_argument('--field_type', default='H', type=str, help='type of vector field to learn (e.g., H, solenoidal)')
